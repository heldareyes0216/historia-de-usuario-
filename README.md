...
2. *Clonar el repositorio*: Para poder obtener el proyecto en tu computador debes clonar el repositorio. Utiliza el siguiente comando: git clone URL_DEL_REPOSITORIO. *Ejemplo*: git clone https://github.com/heldareyes0216/historia-de-usuario-.git
Este comando descargará el proyecto y creará una carpeta con los archivos en tu computador.

3. *Entrar a la carpeta del proyecto*: Debes ir la carpeta donde se encuentra el archivo del programa. Debes usar el comando cd. *Ejemplo*: cd inventario-python.
...
## *estado del proyecto*:
> El proyecto está actualmente en funcionamiento y está demostrando un proceso sencillo de cálculo de inventario en Python.
